...
void QuikcSort_by_Byankina(vector<T>& mass, int start, int end) {          //передаем в функцию массив и его размер
    T i = start;                                      //индекс первого элемента массива
    T j = end;                               //индекс последнего элемента массива
    T mid = mass[(end + start) / 2];            //значение средннго элемента массива, с которым будем сравнивать
